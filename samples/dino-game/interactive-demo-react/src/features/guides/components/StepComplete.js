        ...
        <div className="complete-step">
            ...
            <div className="steps">
                <div >
                    ...
                    <p>Next, we recommend that you check out the <a href="https://featbit.gitbook.io/docs/get-started/connect-an-sdk">Connect an SDK</a> section for a quick overview of how to use FeatBit to connect the Feature flags we've connected in this demo!
                    </p>
                    <ul>
                        <li><a href="https://featbit.gitbook.io/docs/get-started/connect-an-sdk">Click here to go to the documentation page of Connect an SDK</a></li>
                    ...
                    <p>
                        ...
                        <br />
                        Note: The content completed in <a href="https://featbit.gitbook.io/docs/get-started/connect-an-sdk">Connect an SDK</a> will be used in most of the articles in How-to guides
                    </p>
                    <img src={GetStart} />
                </div>
