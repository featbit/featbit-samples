...
{
    public class CustomEventReaderTester
    {
        ...
        public CustomEventReaderTester(string azureEventHubConnectionString)
        {
        ...
        {
            var evt = JsonSerializer.Deserialize<CustomEvent>(Encoding.UTF8.GetString(eventArgs.Data.Body.ToArray()));
            Console.WriteLine($"Received event: {evt.Id} {evt.EventName} {evt.UserId} {evt.CustomEventName} {evt.Timestamp}");
